...
<div class="Add">
		<div class="add">
			<img src="./image/healthneed_advertisement_1.jpg"  >
		  </div>
		  <div class="add">
			<img src="./image/healthneed_advertisement_2.jpg" >
		  </div>
		  <div class="add">			
			<img src="./image/healthneed_advertisement_3.jpg" >
		  </div>
	...
	<script>
        ...
        <div class="product_container">
	      <h2>Health_needs</h2>
		<?php 
		  $covidData = "SELECT * FROM product WHERE product_category='health_needs'";
		  $result = mysqli_query($con,$covidData);
		  while($row = mysqli_fetch_assoc($result)){
	     ?>

              <div class="product_wrapper">
			       <form method="POST" action='health_needs.php'>
