...
<div class="Add">
		<div class="add">
			<img src="./image/babyneeds_advertisement_1.jpg"  >
		  </div>
		  <div class="add">
			<img src="./image/babyneeds_advertisement_2.jpg" >
		  </div>
		  <div class="add">			
	...
	<script>
        ...
        <div class="product_container">
	      <h2>Baby Needs</h2>
		<?php 
		  $covidData = "SELECT * FROM product WHERE product_category='baby_needs'";
		  $result = mysqli_query($con,$covidData);
		  while($row = mysqli_fetch_assoc($result)){
	     ?>

              <div class="product_wrapper">
			       <form method="POST" action='baby_needs.php'>
