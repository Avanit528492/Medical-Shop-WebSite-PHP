...
<div class="Add">
		<div class="add">
			<img src="./image/personalcare_advertisement_1.jpg"  >
		  </div>
		  <div class="add">
			<img src="./image/personalcare_advertisement_2.jpg" >
		  </div>
		  <div class="add">			
	...
	<script>
        ...
        <div class="product_container">
	      <h2>Personal Care</h2>
		<?php 
		  $covidData = "SELECT * FROM product WHERE product_category='personal_care'";
		  $result = mysqli_query($con,$covidData);
		  while($row = mysqli_fetch_assoc($result)){
	     ?>

              <div class="product_wrapper">
			       <form method="POST" action='personal_care.php'>
			       ...
			       <input type='submit' class = "buyButton" value='Buy Now' name="buynow"><br>
			       </form>
		   	    </div>
		 <?php
		  }
