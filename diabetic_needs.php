...
<div class="Add">
		<div class="add">
			<img src="./image/diabetic_advertisement.jpg"  >
		  </div>
		  <div class="add">
	...
	<script>
        ...
        <div class="product_container">
	      <h2>Diabetic Needs</h2>
		<?php 
		  $covidData = "SELECT * FROM product WHERE product_category='diabetic'";
		  $result = mysqli_query($con,$covidData);
		  while($row = mysqli_fetch_assoc($result)){
	     ?>

              <div class="product_wrapper">
			       <form method="POST" action='diabetic_needs.php'>
